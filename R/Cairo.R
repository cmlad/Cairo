...
.supported.types <- c(png="png",png24="png",png32="png",jpeg="jpeg",jpg="jpeg",tiff="tiff",tif="tiff",
					  ...
					  win="win",win32="win",window="win",windows="win",w32="win",raster="raster",svgcapture="svgcapture")
...
CairoSVGCapture <- function(file = ifelse(onefile, "Rplots.svg", "Rplot%03d.svg"),
                     width = 6, height = 6, onefile = TRUE, bg = "transparent",
                     pointsize = 12, ...) {
    if (!onefile) stop("Sorry, SVG backend of Cairo supports onefile=TRUE only")
    Cairo(width, height, type='svgcapture', file=file, pointsize=pointsize, bg=bg, units='in', ...)
}
